    ...
    <div className="min-h-screen bg-[#EAEAEA] flex flex-col items-center justify-center py-12">
      ...
      >
        ...
        <div className="mt-6 text-center space-y-2">
          <Link to="/" className="text-[#1A659E] hover:text-[#022B50] transition duration-200 text-sm block">
            Back to Home
          </Link>
          <p className="text-gray-600 text-sm">
            Don’t have an account?{' '}
            <Link to="/signup/user" className="text-[#1A659E] hover:text-[#022B50] transition duration-200">
              Sign Up as User
            </Link>{' '}
          </p>
        </div>
