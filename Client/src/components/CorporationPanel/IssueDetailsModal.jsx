  ...
  return (
    <>
      ...
      <button
        ...
        className="text-indigo-600 cursor-pointer hover:text-indigo-800 font-medium transition-colors duration-150"
      >
        View Details
      </button>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1 text-gray-800 font-semibold text-wrap">
                    {issue.title}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-800 font-semibold">30-05-2025</p>
                </div>
              </div>
