      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <p className="text-xl md:text-2xl leading-relaxed">
            ...
            community, we turn your reports into action—fast and anonymously.
          </p>
        </div>
          ...
          {[
            {
              title: "Smart AI",
              description:
                "Our tech sorts and sends reports to the right people instantly.",
            },
            {
              title: "Total Privacy",
              description:
                "Blockchain keeps you anonymous, no questions asked.",
            },
            {
        ...
        <div className="mt-20 text-center">
          ...
          <button className="px-8 py-4 bg-[#022B50] text-white rounded-full font-semibold text-lg shadow-lg cursor-pointer transition-colors duration-300">
            Start Reporting
          </button>
        </div>
