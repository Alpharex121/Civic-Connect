  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#022B50] to-[#101117] text-[#c2ccd4] py-20 px-6 overflow-hidden">
      <div className="max-w-6xl mx-auto relative">
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold mb-12 text-center text-[#c2ccd4]">
          Why CivicConnect?
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {[
            ...
            <div
              key={index}
              className={`bg-[#aeb6d3] p-8 rounded-xl  border-t-4 ${
                index % 2 === 0 ? "border-[#4338CA]" : "border-[#4338CA]"
              }`}
            >
              <h2 className="text-2xl font-semibold mb-4 text-black">
                {reason.title}
              </h2>
              <p className="text-black text-lg">{reason.description}</p>
            </div>
          ))}
        </div>
